...
| `completed_with_partial` | Result is usable, but at least one step failed (timeout, blocked link, etc). Inspect the [`coverage`](/concepts/coverage) object to see what was skipped. |
