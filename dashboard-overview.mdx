...
|------|----------------|-----------|
| **Home** | Overview dashboard with **Needs your attention** and **Recent scans** panels, plus stat tiles. | [List org scans](/api/org/list-scans), [Get usage totals](/api/usage/totals) |
...
| **Usage** | Bar chart and donut chart for scan throughput and recommendation distribution. Admin-only in the dashboard. | [Get scan timeseries](/api/usage/scans), [Get priority distribution](/api/usage/priority), [Get usage totals](/api/usage/totals) |
