...
| **History** | Org-wide scan search and filtering — by recommendation, scan mode, date range, and URL/username — plus CSV/Excel export of the filtered results (export is dashboard-only; see [List org scans](/api/org/list-scans#using-the-dashboard)). | [List org scans](/api/org/list-scans) |
