...
- `X-Sherlock-Signature: sha256=<hex>` — when the organization has a
  webhook secret. See [Signature verification](/webhooks/signatures).
...
<ResponseField name="dossier_url" type="string" required>
  ...
  {/* TODO: confirm production dossier URL once the hosted viewer ships — currently returns a relative path */}
</ResponseField>
